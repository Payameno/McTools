...
('FOWLER 1.4-6IN. ELECTRONIC BORE GAGE', 'title: X-Series, Electronic Bore Gage Set, The industries 2 most popular bore gage ranges combined in one easy-to-use electronic set!, FEATURES, Self-centering, Carbide anvils, Includes 2" contact extension, Easily adjustable, Shop hardened case', 'FOWLER', 0, 59119, 'inspection', true),
('KBC .70-1.5IN./18-35MM DIGITAL BORE GAGE', 'title: Precision Digital Bore Gage, FEATURES, Data output RS 232, Inch/Metric conversion, Resolution: .00005" (.002mm), Extra large LCD 360° rotation, Easily calibrated by one button, Easily realize the blind measuring by freezing minimum value, Various measuring head for different size of bore measuring, Double Display: Digital & Electronic Scale, Relative measurement/Absolute measurement, Directly measure the actual value of workpiece', 'KBC', 0, 37192, 'inspection', true),
('DRILL-OUT 7PC NO. 5/6-1/2 EXTRACTOR KIT', 'FEATURES, Removes broken bolts from below surface, flush surface, as well as rusted out bolts in a fraction of the time as compared to tools designed for the same purpose, Can be used with any 3/8" reversible variable speed hand drill', 'ALDEN', 0, 11772, 'handtools', true),
('KBC MICRO CHUCK', 'FEATURES, For use in drill press or hand-held tools, Suitable for 60 to 80 wire gauge drills, Grips drills firmly and accurately, Can be held in any 1/8" or 3/16" collet or larger adjustable drill chuck', 'KBC', 0, 603, 'handtools', true);
